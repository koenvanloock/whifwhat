...
class SeriesRoundServiceTest extends PlaySpec{
  ...
  "SeriesRoundService" should {
    ...
    "isRoundComplete of a complete robinRound returns true" in {
      ...
      val matchesWithGames: List[PingpongMatch] = List(
        PingpongMatch("1",None,None,"1",6,true,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2))),
        PingpongMatch("2",None,None,"1",3,true,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2))),
        PingpongMatch("3",None,None,"1",7,true,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2))),
        PingpongMatch("4",None,None,"1",3,false,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2))),
        PingpongMatch("5",None,None,"1",1,true,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2))),
        PingpongMatch("6",None,None,"1",4,true,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2)))
      )
  ...
  "isRoundComplete of an incomplete robinRound returns false" in {
    val matchesWithGames: List[PingpongMatch] = List(
      PingpongMatch("1",None,None,"1",6,true,21,2,2,0,List(SiteGame(21,16,1),SiteGame(0,15,2))),
      PingpongMatch("2",None,None,"1",3,true,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2))),
      PingpongMatch("3",None,None,"1",7,true,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2))),
      PingpongMatch("4",None,None,"1",3,false,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2))),
      PingpongMatch("5",None,None,"1",1,true,21,2,2,0,List(SiteGame(21,16,1),SiteGame(21,15,2))),
  ...
  "isRoundComplete of a complete bracket returns true" in {
    ...
    val matches =
      BracketNode[PingpongMatch](PingpongMatch("1", None, None,"3", 6,true,21,2, 2, 0,List(SiteGame(21,16,1),SiteGame(21,14,2))),
        BracketLeaf[PingpongMatch](PingpongMatch("1", None, None, "1",7,true,21,2, 2, 0, List(SiteGame(21,16,1),SiteGame(22,20,2)))),
        BracketLeaf(PingpongMatch("1", None, None, "1",3,false,21,2, 2, 0, List(SiteGame(21,16,1),SiteGame(21,10,2))))
      )
  ...
  "isRoundComplete of an incomplete bracket returns false" in {
    ...
    val matches =
      BracketNode[PingpongMatch](PingpongMatch("1", None, None,"3", 6,true,21,2, 1, 0,List(SiteGame(21,16,1),SiteGame(0,0,2))),
        BracketLeaf[PingpongMatch](PingpongMatch("1", None, None, "1",7,true,21,2, 2, 0, List(SiteGame(21,16,1),SiteGame(22,20,2)))),
        BracketLeaf(PingpongMatch("1", None, None, "1",3,false,21,2, 2, 0, List(SiteGame(21,16,1),SiteGame(21,10,2))))
      )
  ...
  "calculate the roundScore of a winning player with a matchUpdate" in {
    seriesRoundService.updateSeriesPlayerAfterMatch(SeriesPlayer("1","3", koen, PlayerScores()), List(
      PingpongMatch("1", Some(koen), None, "1", 2, true, 21, 2, 2,1, List(SiteGame(21,0, 1), SiteGame(15,21, 2),SiteGame(21,19, 3))),
      PingpongMatch("2", Some(koen), None, "1", 5, true, 21, 2, 2,0, List(SiteGame(21,15, 1), SiteGame(23,21, 2)))
  ...
  "calculate the roundScore of a losing player with a matchUpdate" in {
    seriesRoundService.updateSeriesPlayerAfterMatch(SeriesPlayer("1","1", Player("1","Koen", "Van Loock", Ranks.D0), PlayerScores()), List(
      PingpongMatch("1", Some(koen), None, "1", 2, true, 21, 2, 0,2, List(SiteGame(0,21, 1), SiteGame(9,21, 2))),
      PingpongMatch("2", Some(koen), None, "1", 5, true, 21, 2, 1,2, List(SiteGame(21,23, 1), SiteGame(21,16, 2), SiteGame(19,21, 2)))
  ...
  "calculate wins for playerB with a matchUpdate" in {
    seriesRoundService.updateSeriesPlayerAfterMatch(SeriesPlayer("1","1", Player("1","Koen", "Van Loock", Ranks.D0), PlayerScores()), List(
    PingpongMatch("1", Some(koen), None, "1", 2, true, 21, 2, 1,2, List(SiteGame(12,21, 1),SiteGame(21,0, 2), SiteGame(9,21, 3))),
    PingpongMatch("2", None, Some(koen), "1", 5, true, 21, 2, 1,2, List(SiteGame(21,23, 1), SiteGame(21,16, 2), SiteGame(19,21, 2)))
