...
object NuBracket {
  ...
  def main(args: Array[String]) {
    ...
    val l = BracketLeaf(SiteMatch("123",Some(Player("1","Koen","Van Loock", Ranks.D0)), Some(Player("3","Luk","Geraets", Ranks.D6)),"1",3,true,21,2,2,0,List(SiteGame(21,15,1), SiteGame(21,13,2))))
    val r = BracketLeaf(SiteMatch("124",Some(Player("4","Aram","Pauwels", Ranks.B4)), Some(Player("2","Hans","Van Bael", Ranks.E4)),"1",12,true,21,2,2,0,Nil))
    val bracket = BracketNode[SiteMatch](SiteMatch("123",None, None,"2",0,true,21,2,2,0,List()),l, r)
