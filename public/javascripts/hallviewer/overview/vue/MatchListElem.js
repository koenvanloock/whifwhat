Vue.component("match-list-elem", {
  props: ["match", 'color'],
  template: '<div style="border-radius: 20px; border: 1px solid white; display:flex; flex-direction: row" v-bind:style="{background: color}">' +
  '<div style="width: 300px;display: flex; flex-direction: column; padding: 5px 5px 5px 20px; font-weight: bold; color: white;">' +
