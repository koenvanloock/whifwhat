Vue.component("referee-box", {
  ...
  '<p style="margin-top: 90px;float:right;position: relative;z-index: 90;left: -35px;font-weight:bold" class="rotate" v-if="referee">{{referee.firstname +" "+referee.lastname}}</p>' +
  ...
  '<p style="float:right;position: relative;z-index: 90;right:130px;font-weight:bold" v-if="referee">{{referee.firstname +" "+referee.lastname}}</p>' +
  '</div>' +
  '</div>',
